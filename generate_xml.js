...
>
<channel>
	<title>Maajanki Blog Clean Backup (No Remote Media Attachments)</title>
	<link>https://cms.maajankiwebtech.com</link>
	<description>Clean WordPress WXR Export for Manual Media Upload</description>
	<pubDate>Sun, 02 Aug 2026 19:05:00 +0000</pubDate>
...
posts.forEach(post => {
  ...
  // Clean XML: ONLY Post Items (No media attachment nodes to avoid remote fetch errors)
  xml += `
	<item>
...
console.log(`Clean XML Export generated successfully without remote media nodes at ${outputPath}`);
