...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/tools/ai-headline-generator`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${siteUrl}/tools/ai-schema-generator`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
